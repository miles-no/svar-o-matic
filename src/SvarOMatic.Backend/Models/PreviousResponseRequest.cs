...
namespace SvarOMatic.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PreviousResponseRequest : IEquatable<PreviousResponseRequest>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreviousResponseRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PreviousResponseRequest)obj);
        }

        /// <summary>
        /// Returns true if PreviousResponseRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of PreviousResponseRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreviousResponseRequest other)
        {
        ...
        public static bool operator ==(PreviousResponseRequest left, PreviousResponseRequest right)
        {
